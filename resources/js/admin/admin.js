    ...
    $(function() {
        ...
        function addActiveClass(element) {
            if(current === "dashboard"){
                ...
                if(element.attr('href').indexOf('create') === -1 && element.attr('href').indexOf('room') !== -1)
                {
                    element.parents('.nav-item').last().addClass('active');
                ...
                if(element.attr('href').indexOf('create') === -1 && element.attr('href').indexOf('reservation') !== -1)
                {
                    element.parents('.nav-item').last().addClass('active');
                    if (element.parents('.sub-menu').length) {
                        element.closest('.collapse').addClass('show');
                ...
                if(element.attr('href').indexOf('create') === -1 && element.attr('href').indexOf('user') !== -1)
                {
                    element.parents('.nav-item').last().addClass('active');
                    if (element.parents('.sub-menu').length) {
                        element.closest('.collapse').addClass('show');
