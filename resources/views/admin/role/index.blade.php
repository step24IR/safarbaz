@extends('admin.layouts.admin' , ['sectionName' => 'نقش ها'])
                            ...
                            <table class="table text-center">
                                ...
                                @foreach($roles as $key => $role)
                                    <tr>
                                        ...
                                        @can('see_show_role')
                                            <td class="text-white"><a class="btn text-decoration-none" href="{{route('admin.role.show',$role->id)}}"><i class="mdi mdi-eye"></i></a></td>
                                        @endcan
                                        @can('edit_role')
                                            <td class="text-white"><a class="btn text-decoration-none" href="{{route('admin.role.edit',$role->id)}}"><i class="mdi mdi-autorenew"></i></a></td>
                                        @endcan
                                        @can('delete_role')
                                            <td class="text-white"><a href="{{route('admin.role.destroy',$role->id)}}" id="open_delete_panel_{{$key}}" class="btn btn-outline-danger" type="button"><i class="mdi mdi-delete"></i></a></td>
                                        @endcan
                                    </tr>
                                @endforeach
                                </tbody>
